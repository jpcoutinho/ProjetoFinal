...
class MAX30105 {
 public: 
  MAX30105(const nrfx_twi_t* p_m_twi, uint8_t i2caddr = MAX30105_ADDRESS);
  ...
  //FIFO Reading
  int16_t check(void); //Checks for new data and fills FIFO
...
void test(void);
 ...
 private:
  uint8_t _i2caddr;
  const nrfx_twi_t* _m_twi; //The generic connection to user's chosen I2C hardware
